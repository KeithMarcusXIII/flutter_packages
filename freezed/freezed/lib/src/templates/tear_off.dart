...
''';
    ...
    if (serializable) {
      yield '''
$name$genericsParameter fromJson$genericsDefinition(Map<String, Object> json${Abstract.genericsFromJsonArgs(hasGenericArgumentFactories, genericsParameter)}) {
  return $name$genericsParameter.fromJson(json${Abstract.genericsFromJsonArgsNames(hasGenericArgumentFactories, genericsParameter)});
}
''';
    }
  }
