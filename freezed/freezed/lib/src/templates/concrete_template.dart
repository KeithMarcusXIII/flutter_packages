...
import 'package:freezed/src/templates/abstract_template.dart';
...
''';
  ...
  String get _redirectedFromJsonConstructor {
    ...
    return 'factory ${constructor.redirectedName}.fromJson(Map<String, dynamic> json${Abstract.genericsFromJsonArgs(hasGenericArgumentFactories, genericsParameter)}) = $concreteName$genericsParameter.fromJson;';
  }

  String get _concreteFromJsonConstructor {
    if (!shouldGenerateJson) return '';
    return 'factory $concreteName.fromJson(Map<String, dynamic> json${Abstract.genericsFromJsonArgs(hasGenericArgumentFactories, genericsParameter)}) => _\$${concreteName}FromJson(json${Abstract.genericsFromJsonArgsNames(hasGenericArgumentFactories, genericsParameter)});';
  }
  ...
  String get _toJson {
    ...
    return '''
@override
Map<String, dynamic> toJson(${Abstract.genericsToJsonArgs(hasGenericArgumentFactories, genericsParameter)}) {
  return _\$${concreteName}ToJson(this${Abstract.genericsToJsonArgsNames(hasGenericArgumentFactories, genericsParameter)})$addRuntimeType;
}''';
  }
