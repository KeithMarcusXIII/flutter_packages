        ...
        _setStreamType<ValueWrapper<ValueWrapper<String>>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/nestGeneric',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ValueWrapper<ValueWrapper<String>>.fromJson(_result.data!);
    return value;
  }

  @override
  Future<ValueWrapper<Task>> nestGeneric2() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ValueWrapper<Task>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/nestGeneric',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ValueWrapper<Task>.fromJson(_result.data!);
    return value;
  }
