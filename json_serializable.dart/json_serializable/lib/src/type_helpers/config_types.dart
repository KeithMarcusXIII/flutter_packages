...
class KeyConfig {
  ...
  final bool excludeFromJson;

  final bool excludeToJson;
  ...
  KeyConfig({
    ...
    required this.excludeFromJson,
    required this.excludeToJson,
  });
}
...
class ClassConfig implements JsonSerializable {
  ...
  @override
  final bool? bypassKeysFromJson;

  @override
  final bool? bypassKeysToJson;
  ...
  const ClassConfig({
    ...
    required this.includeIfNull,
    required this.bypassKeysFromJson,
    required this.bypassKeysToJson,
  });
  ...
  static const defaults = ClassConfig(
    ...
    includeIfNull: true,
    bypassKeysFromJson: false,
    bypassKeysToJson: false,
  );
...
Map<String, dynamic> _$JsonSerializableToJson(JsonSerializable instance) =>
    <String, dynamic>{
      ...
      'bypassKeysFromJson': instance.bypassKeysFromJson,
      'bypassKeysToJson': instance.bypassKeysToJson,
    };
