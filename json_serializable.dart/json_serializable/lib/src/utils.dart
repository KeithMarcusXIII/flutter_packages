...
JsonSerializable _valueForAnnotation(ConstantReader reader) => JsonSerializable(
      ...
      bypassKeysFromJson:
          reader.read('bypassKeysFromJson').literalValue as bool?,
      bypassKeysToJson: reader.read('bypassKeysToJson').literalValue as bool?,
    );
...
ClassConfig mergeConfig(
  ...
  return ClassConfig(
    ...
    bypassKeysFromJson:
        annotation.bypassKeysFromJson ?? config.bypassKeysFromJson,
    bypassKeysToJson: annotation.bypassKeysToJson ?? config.bypassKeysToJson,
  );
}
