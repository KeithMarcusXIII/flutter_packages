...
KeyConfig _from(FieldElement element, ClassConfig classAnnotation) {
  ...
  return _populateJsonKey(
    ...
    excludeFromJson: obj.read('excludeFromJson').literalValue as bool?,
    excludeToJson: obj.read('excludeToJson').literalValue as bool?,
  );
}
...
KeyConfig _populateJsonKey(
  ...
  return KeyConfig(
    ...
    excludeFromJson: excludeFromJson ?? false,
    excludeToJson: excludeToJson ?? false,
  );
}
