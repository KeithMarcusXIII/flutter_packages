...
JsonSerializable _$JsonSerializableFromJson(Map<String, dynamic> json) {
  return $checkedNew('JsonSerializable', json, () {
    ...
    final val = JsonSerializable(
      ...
      bypassKeysFromJson:
          $checkedConvert(json, 'bypass_keys_from_json', (v) => v as bool?),
      bypassKeysToJson:
          $checkedConvert(json, 'bypass_keys_to_json', (v) => v as bool?),
    );
    return val;
  }, fieldKeyMap: const {
    'anyMap': 'any_map',
    ...
    'bypassKeysFromJson': 'bypass_keys_from_json',
    'bypassKeysToJson': 'bypass_keys_to_json',
  });
}
...
Map<String, dynamic> _$JsonSerializableToJson(JsonSerializable instance) =>
    <String, dynamic>{
      ...
      'bypass_keys_from_json': instance.bypassKeysFromJson,
      'bypass_keys_to_json': instance.bypassKeysToJson,
    };
